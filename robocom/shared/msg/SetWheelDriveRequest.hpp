#ifndef ROBOCOM_SHARED_MSG_SET_WHEEL_DRIVE_REQUEST_HPP
#define ROBOCOM_SHARED_MSG_SET_WHEEL_DRIVE_REQUEST_HPP
...
namespace msg
{
	...
	/**
	 * This class represents the request to change the drive of both
	 * wheel motors on the arduino
	 */
	...
	public:
		...
		/**
		 * Constructs a SetWheelDriveRequest object from the given message
		 */
		explicit SetWheelDriveRequest (const Message& msg) throw ();
